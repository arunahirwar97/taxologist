...
class BroadcastNotification(models.Model):
    message = RichTextField(default=None)
...
def notification_handler(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        task = PeriodicTask.objects.create(crontab=schedule, name="notification-"+str(instance.id), task="notifications_app.tasks.broadcast_notification", args=json.dumps((instance.id,)))
